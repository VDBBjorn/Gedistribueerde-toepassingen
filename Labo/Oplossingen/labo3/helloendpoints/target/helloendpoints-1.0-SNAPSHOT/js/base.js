...
google.devrel.samples.hello.CLIENT_ID =
    '416073108173-h5vs8su1cj5sf5c4u9d4gnook3nhgcu8.apps.googleusercontent.com';
...
/**
 * Oplossing vierkantsvergelijking ophalen.
 * @param {string} a a-coefficient van de vergelijking.
 * @param {string} b b-coefficient van de vergelijking.
 * @param {string} c c-coefficient van de vergelijking.
 */
google.devrel.samples.hello.solveEquation = function(a,b,c) {
  gapi.client.helloworld.greetings.solveEquation({'a': a, 'b': b, 'c': c}).execute(
      function(resp) {
        if (!resp.code) {
          google.devrel.samples.hello.print(resp);
        } else {
...
google.devrel.samples.hello.enableButtons = function() {
  ...
  document.getElementById('solveEquation').onclick = function() {
    google.devrel.samples.hello.solveEquation(
