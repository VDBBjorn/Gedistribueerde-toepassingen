...
namespace BadmintonWebClient.BadmintonServiceReference {
    ...
    public partial class SportClub : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private BadmintonWebClient.BadmintonServiceReference.Tornooi[] TornooienField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public BadmintonWebClient.BadmintonServiceReference.Tornooi[] Tornooien {
            get {
    ...
    public interface IBadmintonService {
        ...
        BadmintonWebClient.BadmintonServiceReference.SportClub[] GetSportClubs();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBadmintonService/GetSportClubs", ReplyAction="http://tempuri.org/IBadmintonService/GetSportClubsResponse")]
        System.Threading.Tasks.Task<BadmintonWebClient.BadmintonServiceReference.SportClub[]> GetSportClubsAsync();
        ...
        BadmintonWebClient.BadmintonServiceReference.Lid[] GetLeden(int sportclubID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBadmintonService/GetLeden", ReplyAction="http://tempuri.org/IBadmintonService/GetLedenResponse")]
        System.Threading.Tasks.Task<BadmintonWebClient.BadmintonServiceReference.Lid[]> GetLedenAsync(int sportclubID);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IBadmintonServiceChannel : BadmintonWebClient.BadmintonServiceReference.IBadmintonService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class BadmintonServiceClient : System.ServiceModel.ClientBase<BadmintonWebClient.BadmintonServiceReference.IBadmintonService>, BadmintonWebClient.BadmintonServiceReference.IBadmintonService {
        ...
        public BadmintonWebClient.BadmintonServiceReference.SportClub[] GetSportClubs() {
            return base.Channel.GetSportClubs();
        }
        
        public System.Threading.Tasks.Task<BadmintonWebClient.BadmintonServiceReference.SportClub[]> GetSportClubsAsync() {
            return base.Channel.GetSportClubsAsync();
        }
        
        public BadmintonWebClient.BadmintonServiceReference.Lid[] GetLeden(int sportclubID) {
            return base.Channel.GetLeden(sportclubID);
        }
        
        public System.Threading.Tasks.Task<BadmintonWebClient.BadmintonServiceReference.Lid[]> GetLedenAsync(int sportclubID) {
